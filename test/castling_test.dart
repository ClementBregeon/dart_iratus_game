...
void main() {
  ...
  test('Short castle works.', () {
    ...
    expect(game.board.get(Position.fromCoords(game.board, 'e8'))!.id == 'k', true);
    ...
    expect(game.board.get(Position.fromCoords(game.board, 'h8')) is Piece, true);
    expect(game.board.get(Position.fromCoords(game.board, 'h8'))!.id == 'r', true);
    ...
    expect(game.board.get(Position.fromCoords(game.board, 'f8')) is Piece, true);
    expect(game.board.get(Position.fromCoords(game.board, 'f8'))!.id == 'r', true);
    expect(game.board.get(Position.fromCoords(game.board, 'g8')) is Piece, true);
    expect(game.board.get(Position.fromCoords(game.board, 'g8'))!.id == 'k', true);
  ...
  test('Long castle works.', () {
    ...
    expect(game.board.get(Position.fromCoords(game.board, 'a1')) is Piece, true);
    expect(game.board.get(Position.fromCoords(game.board, 'a1'))!.id == 'r', true);
    ...
    expect(game.board.get(Position.fromCoords(game.board, 'e1')) is Piece, true);
    expect(game.board.get(Position.fromCoords(game.board, 'e1'))!.id == 'k', true);
    ...
    expect(game.board.get(Position.fromCoords(game.board, 'b1')) == null, true);
    expect(game.board.get(Position.fromCoords(game.board, 'c1'))!.id == 'k', true);
    expect(game.board.get(Position.fromCoords(game.board, 'c1')) is Piece, true);
    expect(game.board.get(Position.fromCoords(game.board, 'd1'))!.id == 'r', true);
    expect(game.board.get(Position.fromCoords(game.board, 'd1')) is Piece, true);
