...
void main() {
  ...
  test('A rolling piece can check from a long distance.', () {
    ...
    expect(
        game.board.validNotations.join(', ') == 'Kg4, Ke4, Kf5, Ke5, Kg3, Kf3',
        true);
  });

  test(
      'A piece can be pinned, being between its king and an enemy rolling piece.',
      () {
    game.move('Kf3');
    game.move('Qc0');
    game.move('Ne2');
